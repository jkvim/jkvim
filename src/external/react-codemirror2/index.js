  ...
  var require_src = __commonJS((exports) => {
      ...
      wire(props) {
        Object.keys(props || {}).filter((p) => /^on/.test(p)).forEach((prop) => {
          switch (prop) {
            case "onBlur":
              {
                this.editor.on("blur", (cm2, event) => {
                  this.props.onBlur(this.editor, event);
                });
              }
              break;
            case "onContextMenu": {
              this.editor.on("contextmenu", (cm2, event) => {
                this.props.onContextMenu(this.editor, event);
              });
              break;
            }
            case "onCopy": {
              this.editor.on("copy", (cm2, event) => {
            ...
            case "onCursor":
              {
                this.editor.on("cursorActivity", (cm2) => {
            ...
            case "onCursorActivity":
              ...
              break;
            case "onCut": {
              this.editor.on("cut", (cm2, event) => {
                this.props.onCut(this.editor, event);
              });
              break;
            }
            case "onDblClick": {
              this.editor.on("dblclick", (cm2, event) => {
            ...
            case "onDragEnter":
              {
                this.editor.on("dragenter", (cm2, event) => {
                  this.props.onDragEnter(this.editor, event);
                });
              }
              break;
            case "onDragLeave": {
              this.editor.on("dragleave", (cm2, event) => {
            ...
            case "onDragOver":
              {
                this.editor.on("dragover", (cm2, event) => {
                  this.props.onDragOver(this.editor, event);
                });
              }
              break;
            case "onDragStart": {
              this.editor.on("dragstart", (cm2, event) => {
            ...
            case "onFocus":
              {
                this.editor.on("focus", (cm2, event) => {
            ...
            case "onGutterClick":
              {
                this.editor.on("gutterClick", (cm2, lineNumber, gutter, event) => {
            ...
            case "onInputRead":
              {
                this.editor.on("inputRead", (cm2, EditorChangeEvent) => {
            ...
            case "onKeyDown":
              {
                this.editor.on("keydown", (cm2, event) => {
            ...
            case "onKeyHandled":
              {
                this.editor.on("keyHandled", (cm2, key, event) => {
            ...
            case "onKeyPress":
              {
                this.editor.on("keypress", (cm2, event) => {
            ...
            case "onKeyUp":
              {
                this.editor.on("keyup", (cm2, event) => {
                  this.props.onKeyUp(this.editor, event);
                });
              }
              break;
            case "onMouseDown": {
              this.editor.on("mousedown", (cm2, event) => {
                this.props.onMouseDown(this.editor, event);
              });
              break;
            }
            case "onPaste": {
              this.editor.on("paste", (cm2, event) => {
                this.props.onPaste(this.editor, event);
              });
              break;
            }
            case "onRenderLine": {
              this.editor.on("renderLine", (cm2, line, element) => {
            ...
            case "onSelection":
              {
                this.editor.on("beforeSelectionChange", (cm2, data) => {
                  this.props.onSelection(this.editor, data);
                });
              }
              break;
            case "onTouchStart": {
              this.editor.on("touchstart", (cm2, event) => {
            ...
            case "onViewportChange":
              {
                this.editor.on("viewportChange", (cm2, from, to) => {
    ...
    class Controlled extends React.Component {
      ...
      hydrate(props) {
        ...
        const userDefinedOptions = Object.assign({}, cm.defaults, this.editor.options, _options);
      ...
      componentDidMount() {
        ...
        this.editor.on("beforeChange", (cm2, data) => {
          if (this.emulating) {
            return;
          }
          data.cancel();
        ...
        this.editor.on("change", (cm2, data) => {
          if (!this.mounted) {
            return;
          }
